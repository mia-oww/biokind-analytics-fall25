...
rural = pd.read_csv("ruralbirths_w_<_5_visits.csv")
nonrural = pd.read_csv("_5 prenatal care suburban - Sheet1.csv")
...
axes[0].set_title("Rural Average Count (<5 Prenatal Visits)")
...
axes[1].set_title("Non-Rural Average Count (<5 Prenatal Visits)")
axes[1].set_xlabel("Year")
axes[1].set_ylabel("Avg Count")
# scales to actual nonrural values

plt.suptitle("Comparison of <5 Prenatal Visits — GA Counties (2018–2024)")
